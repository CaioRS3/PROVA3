...
public class CadastroClientes extends JFrame implements ActionListener {
	...
	public CadastroClientes() {
		...
		comboEstado = new JComboBox<>(new String[] { "", "AC", "AL", "AP", "AM", "BA", "CE", "DF", "ES", "GO", "MA",
	...
	private void consultarCliente() {
		...
		String clienteSelecionado = (String) JOptionPane.showInputDialog(this, "Selecione o cliente:",
				"Consultar Cliente", JOptionPane.QUESTION_MESSAGE, null, clientes, clientes[0]);
	...
	private static class Cliente {
		...
		public Cliente(String nome, String cpf, String estado, String telefone, String email, String dataCadastro,
				String status, String faturamento) {
			this.nome = nome;
			this.cpf = cpf;
			this.estado = estado;
